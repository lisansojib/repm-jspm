...
export default {
    ...
    // API related options  
    baseUrl: baseUrl, // The base url used for all authentication related requests, including provider.url below. This appends to the httpClient/endpoint base url, it does not override it. 
